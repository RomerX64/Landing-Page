...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/axios/lib/axios.js [app-route] (ecmascript)"); // Necesitarás Axios o cualquier otra librería para realizar la solicitud HTTP
;
;
;
const authOptions = {
    ...
    callbacks: {
        async session ({ session, token }) {
            ...
            try {
                ...
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].post(`${process.env.NEXTAUTH_URL}/api/auth/register`, {
                    email,
                    name
                });
                const userData = response.data.user;
                if (!userData) throw new Error("Error en el registro o recuperación del usuario");
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__8cea5e._.js.map