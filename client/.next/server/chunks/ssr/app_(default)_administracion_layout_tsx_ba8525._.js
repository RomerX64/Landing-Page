...
const AdminPanel = ()=>{
    ...
    const filteredUsers = allUsers.filter((user)=>{
        ...
        if (selectedPlans.length > 0) {
            if (user.subscripcion && user.subscripcion.plan && selectedPlans.includes(user.subscripcion.plan.id)) {
                matchesPlan = true;
            } else {
                matchesPlan = false;
            }
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: planes.map((plan)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                className: `px-4 py-2 rounded-lg text-white cursor-pointer transition-colors ${selectedPlans.includes(plan.id) ? "bg-indigo-600" : "bg-gray-700"}`,
                                children: plan.name
                            }, plan.id, false, {
                                fileName: "[project]/app/(default)/administracion/layout.tsx",
                                lineNumber: 105,
