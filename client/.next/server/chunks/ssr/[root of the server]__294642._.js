...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$Api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/app/api/Api.ts [app-ssr] (ecmascript)");
...
const UserProvider = ({ children })=>{
    ...
    const deleteUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (signInData)=>{
        const { data: response, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$error$2e$helper$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleAsync"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$Api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete("/users/user", {
            data: signInData
        }));
        if (error || !response?.data) {
    ...
    const updateUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (updateUserData)=>{
        ...
        const { data: response, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$error$2e$helper$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleAsync"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$Api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/users/update/${user.id}`, {
            ...updateUserData
        }));
        if (error || !response?.data) {
...
const AdminProvider = ({ children })=>{
    ...
    const getUser = async (userId)=>{
        const { data, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$error$2e$helper$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleAsync"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$Api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/admin/user/${userId}`));
        if (error || !data) {
    ...
    const putAdmin = async (userId)=>{
        const { data, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$error$2e$helper$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleAsync"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$Api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/admin/admin/${userId}`));
        if (error || !data) {
    ...
    const getAllPlans = async ()=>{
        ...
        const { data, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$error$2e$helper$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleAsync"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$Api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/admin/plans"));
        if (error || !data) {
    ...
    const createPlan = async (plan)=>{
        const { data, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$error$2e$helper$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleAsync"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$Api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/admin/plans", plan));
        if (error || !data) {
    ...
    const updatePlan = async (planId, plan)=>{
        const { data, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$error$2e$helper$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleAsync"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$Api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/admin/plans/${planId}`, plan));
        if (error || !data) {
    ...
    const deletePlan = async (planId)=>{
        const { error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$error$2e$helper$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleAsync"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$Api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/admin/plans/${planId}`));
        if (error) {
    ...
    const getAllSubscriptions = async ()=>{
        ...
        const { data, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$error$2e$helper$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleAsync"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$Api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/admin/subscriptions"));
        if (error || !data) {
    ...
    const getSubscriptionById = async (subscriptionId)=>{
        const { data, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$error$2e$helper$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleAsync"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$Api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/admin/subscriptions/${subscriptionId}`));
        if (error || !data) {
    ...
    const updateSubscriptionStatus = async (subscriptionId, status)=>{
        const { data, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$error$2e$helper$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleAsync"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$Api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/admin/subscriptions/${subscriptionId}/status`, {
            status
        }));
        if (error || !data) {
    ...
    const cancelSubscription = async (subscriptionId, reason)=>{
        const { data, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$error$2e$helper$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleAsync"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$Api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/admin/subscriptions/${subscriptionId}/cancel`, {
            reason
        }));
        if (error || !data) {
...
"[project]/interfaces/Subscripcion.interface.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$Api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/app/api/Api.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$error$2e$helper$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/utils/error.helper.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$interfaces$2f$Subscripcion$2e$interface$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/interfaces/Subscripcion.interface.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$user$2e$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/context/user.context.tsx [app-ssr] (ecmascript)");
...
const SubscriptionProvider = ({ children })=>{
    ...
    const suscribirse = async (planId, paymentMethodToken, email)=>{
        try {
            ...
            // Redireccionar al perfil del usuario o mostrar mensaje de éxito
            router.push("/perfil");
    ...
    const desuscribirse = async ()=>{
        ...
        try {
            // Verificar que tenemos un ID de suscripción de MercadoPago
            if (!sub.mercadopagoSubscriptionId) {
                console.error("ID de suscripción de MercadoPago no disponible");
                return;
            }
            ...
            if (!data?.data?.subscription) {
                console.error("No se retornaron datos de la suscripción cancelada");
                return;
            }
            // Actualizar el estado con la suscripción cancelada
            // Dependiendo de cómo maneje tu API, podrías recibir la suscripción actualizada
            // con estado "CANCELLED" o podrías querer establecerla como null
            const cancelledSubscription = data.data.subscription;
            if (cancelledSubscription.status === __TURBOPACK__imported__module__$5b$project$5d2f$interfaces$2f$Subscripcion$2e$interface$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SubscriptionStatus"].CANCELLED) {
                setSub(cancelledSubscription);
                localStorage.setItem("subscripcion", JSON.stringify(cancelledSubscription));
            } else {
                // Si prefieres eliminar completamente la info de suscripción cuando se cancela
                setSub(null);
                localStorage.removeItem("subscripcion");
            }
            // Opcional: refrescar la página o mostrar mensaje de éxito
    ...
    const fetchSub = async ()=>{
        if (!user) return null;
        // Si ya tenemos la suscripción del usuario, usarla
        ...
        try {
            ...
            console.error("Excepción en fetchSub:", err);
            return null;
        }
    };
    // Cargar la suscripción cuando cambia el usuario
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (user) {
            fetchSub();
        } else {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__294642._.js.map