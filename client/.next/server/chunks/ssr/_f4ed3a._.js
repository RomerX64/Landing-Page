...
const PaymentForm = ()=>{
    ...
    const handleFormSubmit = async (formData, additionalData)=>{
        ...
        try {
            ...
            setProgress(10);
            const result = await suscribirse(viewPlan.id, paymentMethodToken, email // Ahora TypeScript sabe que email no es undefined
            );
            if (!result.success) {
...
//# sourceMappingURL=_f4ed3a._.js.map