(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_1a71ff._.js", {
...
const PaymentForm = ()=>{
    ...
    const handleFormSubmit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PaymentForm.useCallback[handleFormSubmit]": async (formData)=>{
            if (!viewPlan) return;
            try {
    ...
    }["PaymentForm.useCallback[handleFormSubmit]"], [
        viewPlan,
        suscribirse,
        router
    ]);
    const memoizedCardPayment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PaymentForm.useMemo[memoizedCardPayment]": ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mercadopago$2f$sdk$2d$react$2f$esm$2f$bricks$2f$cardPayment$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__CardPayment$3e$__["CardPayment"], {
                initialization: {
                    amount: viewPlan ? viewPlan.precio : 0
                },
                onSubmit: handleFormSubmit,
                onError: {
                    "PaymentForm.useMemo[memoizedCardPayment]": (error)=>{
                        console.error("Error en el Brick de Pago:", error);
                    }
                }["PaymentForm.useMemo[memoizedCardPayment]"],
                customization: {
                    visual: {
                        style: {
                            theme: "dark"
...
_s(PaymentForm, "ekP6IYGhIU9mzyKOniM8nIpZPuM=", false, function() {
    return [
...
//# sourceMappingURL=_1a71ff._.js.map